...
<body>
	...
	<form action="fly" method="post" class="bg-secondary container pt-9 border border-5 border border-info">
		...
		<div class="col-sm-3">
			<label for="exampleInputEmail1" class="form-label">quantity </label> <input
				type="text" class="form-control" id="exampleInputEmail1"
				aria-describedby="emailHelp" placeholder="quantity" name="quantity">
		</div>
