...
<body>
	...
	<form action="accelerate" method="post">

		<div class="input-group mb-3">
			<span class="input-group-text" id="basic-addon1">bike name</span> <input
				type="text" class="form-control" placeholder="bike name"
				aria-label="Username" aria-describedby="basic-addon1" name="name">
		</div>

		<div>
			select cc <select class="form-select"
				aria-label="Default select example" name="cc">
				<option selected>Open this to select cc</option>
